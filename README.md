...
Welcome to your interactive Machine Learning curriculum! This workspace contains 20 comprehensive Jupyter notebooks designed to take you from data manipulation fundamentals all the way to building deep neural networks, time-series forecasting, NLP, recommender systems, association rule mining, and Bayesian optimization.
...
- **Example Code**: Concrete implementations using `numpy`, `pandas`, `matplotlib`, `seaborn`, `scipy`, `statsmodels`, `optuna`, and `scikit-learn`.
- **Exercises**: At least 3 exercises per chapter, stepping up from **Easy** to **Medium** to **Hard**.
...
1. 📊 **[Chapter 1: Data Manipulation](file:///root/notebooks/Python/tests/Chapter_01_Data_Manipulation.ipynb)**
   - Topics: NumPy arrays, vectorization, Pandas indexing, slicing, filtering, Groupby aggregations, and matrix multiplication.
2. 🧹 **[Chapter 2: Data Preprocessing & Cleaning](file:///root/notebooks/Python/tests/Chapter_02_Data_Cleaning.ipynb)**
   - Topics: Imputing missing values, Ordinal & One-Hot categorical encoding, and custom outlier-clipping scaling.
3. 📈 **[Chapter 3: Data Visualization & Plotting](file:///root/notebooks/Python/tests/Chapter_03_Data_Plotting.ipynb)**
...
4. 📉 **[Chapter 4: Linear & Logistic Regression](file:///root/notebooks/Python/tests/Chapter_04_Regression.ipynb)**
...
5. 🌲 **[Chapter 5: Decision Trees & Random Forests](file:///root/notebooks/Python/tests/Chapter_05_Decision_Trees.ipynb)**
...
6. 🛡️ **[Chapter 6: Support Vector Machines & Naive Bayes](file:///root/notebooks/Python/tests/Chapter_06_SVM_and_Naive_Bayes.ipynb)**
...
7. 🧩 **[Chapter 7: Unsupervised Learning & Clustering](file:///root/notebooks/Python/tests/Chapter_07_Unsupervised_Learning.ipynb)**
   - Topics: PCA dimension reduction, K-Means clustering, the Elbow Method, and implementing K-Means from scratch in NumPy.
8. ⚙️ **[Chapter 8: Feature Engineering & Selection](file:///root/notebooks/Python/tests/Chapter_08_Feature_Engineering.ipynb)**
...
9. 🎯 **[Chapter 9: Model Evaluation & Hyperparameter Tuning](file:///root/notebooks/Python/tests/Chapter_09_Model_Evaluation.ipynb)**
   - Topics: K-Fold cross-validation, GridSearchCV vs. GridSearchCV, and F1-score classification threshold tuning.

### 4. Advanced Topics
10. 🧠 **[Chapter 10: Introduction to Deep Learning](file:///root/notebooks/Python/tests/Chapter_10_Deep_Learning.ipynb)**
...
11. ⏱️ **[Chapter 11: Time Series Analysis & Forecasting](file:///root/notebooks/Python/tests/Chapter_11_Time_Series.ipynb)**
...
12. 🗣️ **[Chapter 12: Natural Language Processing (NLP)](file:///root/notebooks/Python/tests/Chapter_12_NLP.ipynb)**
...
13. 🚨 **[Chapter 13: Anomaly Detection](file:///root/notebooks/Python/tests/Chapter_13_Anomaly_Detection.ipynb)**
...
14. 🤝 **[Chapter 14: Ensemble Learning & Gradient Boosting](file:///root/notebooks/Python/tests/Chapter_14_Ensemble_Learning.ipynb)**
...
15. 🌌 **[Chapter 15: Dimensionality Reduction & Manifold Learning](file:///root/notebooks/Python/tests/Chapter_15_Manifold_Learning.ipynb)**
...
16. 🎬 **[Chapter 16: Recommender Systems](file:///root/notebooks/Python/tests/Chapter_16_Recommender_Systems.ipynb)**
...
17. 🛒 **[Chapter 17: Association Rule Learning](file:///root/notebooks/Python/tests/Chapter_17_Association_Rule_Learning.ipynb)**
    - Topics: Support, Confidence, Lift metric logic, the Apriori Frequent Itemsets algorithm, and rule extraction.
18. 🌓 **[Chapter 18: Semi-Supervised Learning](file:///root/notebooks/Python/tests/Chapter_18_Semi_Supervised_Learning.ipynb)**
...
19. ⚖️ **[Chapter 19: Classification on Imbalanced Data](file:///root/notebooks/Python/tests/Chapter_19_Imbalanced_Classification.ipynb)**
    - Topics: Accuracy vs. Macro F1 score metrics traps, random oversampling from scratch, and cost-sensitive SVC.
20. 🔧 **[Chapter 20: Hyperparameter Optimization with Optuna](file:///root/notebooks/Python/tests/Chapter_20_Hyperparameter_Optimization.ipynb)**
...
At the end of each exercise, you'll see a verification cell. You can use the local **[learntools.py](file:///root/notebooks/Python/tests/learntools.py)** module to guide you.
